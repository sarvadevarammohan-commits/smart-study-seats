...
import { BookOpen, Shield, Mail, Lock, ArrowLeft, RefreshCw, Sparkles, Users, BarChart3, User } from 'lucide-react';
    ...
    <div className="min-h-screen flex items-center justify-center bg-background p-4 relative overflow-hidden">
      ...
      >
        ...
        <div className="text-center mb-10">
          ...
          <motion.h1 initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.35 }} className="text-3xl font-display font-bold text-foreground tracking-tight">
            Smart Library
          </motion.h1>
          <motion.p initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.45 }} className="text-muted-foreground text-sm mt-2 flex items-center justify-center gap-1.5">
        ...
        <AnimatePresence mode="wait">
          {!role ? (
            <motion.div key="roles" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} transition={{ duration: 0.3 }} className="space-y-3">
              ...
              <motion.button whileHover={{ scale: 1.02, y: -2 }} whileTap={{ scale: 0.98 }} onClick={() => selectRole('student')}
                ...
                <div className="w-14 h-14 rounded-xl flex items-center justify-center transition-all duration-300 group-hover:scale-110" style={{ background: 'var(--gradient-hero)' }}>
                ...
                <motion.div className="w-10 h-10 rounded-full bg-primary/10 flex items-center justify-center group-hover:bg-primary/20 transition-colors" whileHover={{ x: 3 }}>
                  <ArrowLeft className="w-4 h-4 text-primary rotate-180" />
                </motion.div>
              </motion.button>

              <motion.button whileHover={{ scale: 1.02, y: -2 }} whileTap={{ scale: 0.98 }} onClick={() => selectRole('admin')}
                ...
                style={{ boxShadow: 'var(--shadow-card)' }}>
                <div className="w-14 h-14 rounded-xl flex items-center justify-center transition-all duration-300 group-hover:scale-110" style={{ background: 'var(--gradient-admin)' }}>
                ...
                <motion.div className="w-10 h-10 rounded-full bg-destructive/10 flex items-center justify-center group-hover:bg-destructive/20 transition-colors" whileHover={{ x: 3 }}>
            ...
            <motion.form key="form" initial={{ opacity: 0, x: 30 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -30 }} transition={{ duration: 0.3 }}
              onSubmit={handleSubmit} className="rounded-xl border border-border bg-card p-6 space-y-4" style={{ boxShadow: 'var(--shadow-elevated)' }}>
              <div className="flex items-center gap-3 mb-1">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm font-display font-bold text-foreground capitalize">{role}</span>
                </div>
              </div>
              ...
              {authMode === 'signup' && (
                <div className="space-y-1.5">
                  ...
                  <div className="relative">
                    ...
                    <Input type="text" value={name} onChange={e => setName(e.target.value)} className="pl-10" placeholder="Enter your full name" required />
                  </div>
                </div>
              )}
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  ...
                  <Input type="email" value={email} onChange={e => setEmail(e.target.value)} className="pl-10" placeholder="Enter your email" required />
                </div>
              </div>
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  ...
                  <Input type="password" value={password} onChange={e => setPassword(e.target.value)} className="pl-10" placeholder={authMode === 'signup' ? 'Min 6 characters' : 'Enter password'} required minLength={6} />
                </div>
              </div>
              ...
              <div className="space-y-2 pt-1">
                ...
                <Input type="text" value={captchaInput} onChange={e => setCaptchaInput(e.target.value)} placeholder="Type the characters above" required maxLength={5} className="font-mono tracking-[0.3em] text-center" autoComplete="off" />
              </div>
              ...
              <Button type="submit" className="w-full h-11 font-display font-semibold text-sm" disabled={loading || captchaInput.length < 5}>
                {loading ? (
